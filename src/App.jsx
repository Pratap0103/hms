...
import Master from './pages/admin/PMS/Master';
...
import AssignNursetask from './pages/admin/Nursetask/AssignNursetask';
import Tasks from './pages/admin/Nursetask/Tasks';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="pms/master" element={<Master />} />

        {/* Nurse Task Routes */}
        <Route path="nursetask/assign" element={<AssignNursetask />} />
        <Route path="nursetask/tasks" element={<Tasks />} />
      </Route>
