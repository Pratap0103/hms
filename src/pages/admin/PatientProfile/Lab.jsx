...
import { FileText, Download, Plus, X, ArrowLeft } from 'lucide-react';
                    ...
                    {pendingList.map((p, i) => (
                      <tr key={i} className="border-b hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3">
                          <span className={`px-3 py-1 rounded-full text-xs font-semibold ${p.priority === 'High' ? 'bg-red-100 text-red-700' :
                  ...
                  <tbody>
                    {historyList.map((h, i) => (
                      <tr key={i} className="border-b hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3">
                          <span className={`px-3 py-1 rounded-full text-xs font-semibold ${h.priority === 'High' ? 'bg-red-100 text-red-700' :
